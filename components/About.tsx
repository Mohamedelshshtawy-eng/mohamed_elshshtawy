...
import { motion } from "framer-motion"
import { Download, Award, Play } from "lucide-react"
import Image from "next/image"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative w-full max-w-md mx-auto group">
              <div className="aspect-square rounded-2xl overflow-hidden border-2 border-cyan-400/30 relative">
                {!showVideo ? (
                  <>
                    {/* Image */}
                    <Image
                    ...
                    <button
                      ...
                      className="absolute inset-0 flex items-center justify-center bg-black/60 text-white hover:bg-black/80 transition"
                    >
                  ...
                  <motion.video
                    ...
                    controls
                    autoPlay
                    onEnded={() => setShowVideo(false)} // يرجع الصورة بعد انتهاء الفيديو
          ...
          >
            <div className="space-y-4 text-slate-300 leading-relaxed">
              <p className="text-lg">
                Hello! I'm a unique blend of scientist and developer, bringing analytical thinking from my Chemistry and
                Zoology background into the world of technology. My journey started in the laboratory...
              </p>

              <p className="text-lg">
                As an Educational Diploma holder and Chemistry Teacher, I've honed my ability to break down complex
                concepts and communicate them effectively...
              </p>
